...
<?php echo $this->Form->create('UserDonation'); ?>
	<fieldset>
		<legend><?php echo __('Edit User Donation'); ?></legend>
	<?php
...
<div class="actions bake-header">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('UserDonation.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('UserDonation.id'))); ?></li>
