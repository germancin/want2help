<div class="batchesUsers index bake-header">
	<h2><?php echo __('Batches Users'); ?></h2>
	...
	<?php foreach ($batchesUsers as $batchesUser): ?>
	<tr>
		<td><?php echo h($batchesUser['BatchesUser']['id']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $batchesUser['BatchesUser']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $batchesUser['BatchesUser']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $batchesUser['BatchesUser']['id']), null, __('Are you sure you want to delete # %s?', $batchesUser['BatchesUser']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
