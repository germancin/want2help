...
<?php echo $this->Form->create('BatchesUser'); ?>
	<fieldset>
		<legend><?php echo __('Edit Batches User'); ?></legend>
	<?php
...
<div class="actions bake-header">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('BatchesUser.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('BatchesUser.id'))); ?></li>
