...
<div class="actions bake-header">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Donation.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Donation.id'))); ?></li>
