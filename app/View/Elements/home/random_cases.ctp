<section class="block">
	<div class="container">
		<div class="nine-column">
			...
			<div class="our-causes" style="height:358px; border:0px solid black">	
				<div class="list_carousel2">
					<div id="pager" class="pager"></div>
					<ul id="causes2" >
						<li style="position:relative; left:-10px">
							<div class="causes-image">
								<img src="http://placehold.it/270x358" alt="thumb1" />
						...
						<li>
							<div class="causes-image">
								...
								<div class="cause-heading">
									<h3>Donate and give clean water</h3>
									<p>We needed to collect: <span>$29,000</span> </p>
								</div>
									<div class="our-causes-hover">
										<h3>Feeding the Hungry</h3>
										<span>in <i>South Africa</i></span>
										<p>Duis accumsan rhosn cius arcvira orem bland it sit admet. Sedi ceel ugue. In idn iacues ante. Proi rien is mi gravida viverra.</p>
										<span class="help"><strong>Help us</strong> to collect:</span>
										<span class="needed-amount">$20,000 </span>
									</div>
							</div>
							<div class="causes-image">
								<img src="http://placehold.it/270x358" alt="thumb1" />
							...
							<div class="causes-image">
								<img src="http://placehold.it/270x358" alt="thumb1" />
									<div class="cause-heading">
										<h3>Supporting a day centre</h3>
										<p>We needed to collect: <span>$30,000</span> </p>
									</div>
								<div class="our-causes-hover">
									<h3>Feeding the Hungry</h3>
									<span>in <i>South Africa</i></span>
		...
		<div class="three-column pull-right">
			<div class="sec-heading">
